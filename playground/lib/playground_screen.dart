...
class _PlaygroundScreenState extends State<PlaygroundScreen> {
                      ...
                      Expanded(
                        child: Container(
                          decoration: BoxDecoration(
                            border: Border(
                              left: BorderSide(color: Colors.black.withValues(alpha: 0.05), width: 1),
  ...
  Widget _sidebar() {
    return Container(
      color: const Color.fromARGB(255, 208, 236, 255), // Deeper bluish tint for sidebar
                    ...
                    (c) => Padding(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          c.name,
                          style: TextStyle(
                            color: selectedComponent?.name == c.name ? const Color(0xFF1E1E4C) : Colors.black87,
                            fontSize: 16,
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    _deviceIcon(Icons.desktop_windows, !isMobile, () => setState(() => isMobile = false)),
                    _deviceIcon(Icons.phone_iphone, isMobile, () => setState(() => isMobile = true)),
                  ],
                ),
              ),
            ],
              ...
              child: ClipRRect(
                ...
                child: Center(
                  child: selectedComponent == null
                      ...
                      : LayoutBuilder(
                          builder: (context, constraints) {
                            final isPage = selectedComponent?.category == 'Pages';
                            final double targetWidth = isPage || !isMobile ? constraints.maxWidth : 375.0;
                            final double targetHeight = isPage || !isMobile ? constraints.maxHeight : 812.0;
                            ...
                            return AnimatedContainer(
                              ...
                              height: targetHeight,
                              decoration: BoxDecoration(
                                color:  Color.fromARGB(255, 193, 230, 255), // Bluish tint for preview
                                borderRadius: isMobile && !isPage ? BorderRadius.circular(40) : BorderRadius.circular(24),
                                border: Border.all(
                                  color: Colors.black.withValues(alpha: 0.05), 
                              ...
                              child: ClipRRect(
                                borderRadius: isMobile && !isPage ? BorderRadius.circular(32) : BorderRadius.circular(16),
                                child: Center(
                                  child: ConstrainedBox(
                                          ...
                                          constraints: BoxConstraints(
                                            maxWidth: isMobile 
                                                ...
                                                : (selectedComponent?.category == 'Pages' 
                                                    ? 1300 
                                                    : (selectedComponent?.category == 'Organisms' 
                                                        ? 800 
                                                        : 600)),
                                            maxHeight: isMobile 
                                                ? targetHeight 
    ...
    return GlassContainer(
      ...
      child: Column(
        ...
        children: [
          Text(
            title,
            style: const TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold), // Changed from white70
          ),
          const SizedBox(height: 16),
          ...children,
        ],
  ...
  Widget _propertyBoolInput(String label, String key) {
    return SwitchListTile(
      ...
      title: Text(label, style: const TextStyle(color: Colors.black, fontSize: 18)), // Changed from black87
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Expanded(child: Text(label, style: const TextStyle(color: Colors.black, fontSize: 15), overflow: TextOverflow.ellipsis)),
            SizedBox(
              width: 60,
              height: 24,
              child: TextField(
  ...
  Widget _infoRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Expanded(child: Text(label, style: const TextStyle(color: Colors.black, fontSize: 15), overflow: TextOverflow.ellipsis)),
          Text(value, style: const TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold)), // Changed from black87
        ],
      ),
    );
  }
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isSelected ? const Color(0xFF1E1E4C) : Colors.black12),
          ),
          child: Center(
            child: Text(
              label,
        ...
        title: Row(
          children: [
            ...
            Text(
              ...
              style: const TextStyle(color: Color(0xFF1E1E4C), fontWeight: FontWeight.bold),
            ),
          ],
        ),
        content: Container(
