          ...
          MouseRegion(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _isHovering
                    ? const Color.fromARGB(255, 27, 27, 27).withOpacity(0.05)
                    : const Color(0x1FFFFFFF),
                borderRadius: BorderRadius.circular(30), // Pill shape
                border: Border.all(
                  color: (hasError && widget.showErrorText) ? Colors.red : Colors.black.withOpacity(0.1), // Visible border
                  width: 1.5,
                ),
              ),
              child: m.TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                    color: Colors.black.withOpacity(0.3), // Darker hint for better visibility
                    fontSize: 20,
                  ),
